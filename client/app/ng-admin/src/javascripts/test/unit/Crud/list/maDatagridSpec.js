...
describe('directive: ma-datagrid', function() {
    ...
    it("should add list actions", function() {
        ...
        var element = $compile(directiveUsage)(scope);
        scope.$digest();
        expect(element[0].querySelector('thead th:nth-child(2)')
                .innerHTML)
            .toContain('ACTIONS');
        expect(element[0].querySelector('tbody tr td:nth-child(2) ma-list-actions')
                .nodeName)
            .toContain('MA-LIST-ACTIONS');
    });
    it("should add columns", function() {
        ...
        scope.$digest();
        expect(element[0].querySelector('tbody tr td:nth-child(1) ma-column')
                .nodeName)
            .toContain('MA-COLUMN');
    });
});