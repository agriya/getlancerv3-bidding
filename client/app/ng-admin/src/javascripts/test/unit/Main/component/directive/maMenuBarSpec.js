...
describe('directive: ma-menu-bar', function() {
    ...
    it('should autoClose menu when autoClose is true', function() {
        var postMenu = new Menu(post)
            .title('post')
            .link('/post');
        var commentMenu = new Menu(comment)
            .title('comment')
            .link('/comment');
        var tagMenu = new Menu(tag)
            .title('tag')
            .link('/tag');
        var blogMenu = new Menu(blog)
            .title('blog')
            .addChild(postMenu)
